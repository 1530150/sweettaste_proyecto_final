            ...
            <div class="page-contentbar">
                ...
                <div id="page-right-content">
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-sm-12">
                                <h4 class="m-t-0 header-title">Agregar producto</h4>
                                <a href="productos.php" class="btn btn-custom" style="float: right; display: inline;">Atrás</a>

                               <div class="col-lg-6">
                                <div class="p-20 m-b-20">
                                    <div class="p-20 m-b-20">
                                        <form action="modificar/modificar-producto.php" class="form-validation" method="POST">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="nombre" parsley-trigger="change" required
                                                       placeholder="Nombre" class="form-control" id="Nombre" value="<?php echo $producto[1] ?>">
                                            </div>
                                            <div class="form-group">
                                                <label for="Tipo">Tipo<span class="text-danger">*</span></label>
                                                <input type="text" name="tipo" parsley-trigger="change" required
                                                       placeholder="Tipo" class="form-control" id="Tipo" value="<?php echo $producto[2] ?>">
                                            </div>
                                            <div class="form-group">
                                                <label for="Sabor">Sabor<span class="text-danger">*</span></label>
                                                <input type="text" name="sabor" parsley-trigger="change" required
                                                       placeholder="Sabor" class="form-control" id="Sabor" value="<?php echo $producto[3] ?>">
                                            </div>
                                            <div class="form-group">
                                                <label for="Complementos">Complementos<span class="text-danger">*</span></label>
                                                <input type="text" name="complementos" parsley-trigger="change" required
                                                       placeholder="Complementos" class="form-control" id="Complementos" value="<?php echo $producto[4] ?>">
                                            </div>
                                            <div class="form-group">
                                                <label for="Tamano">Tamaño<span class="text-danger">*</span></label>
                                                <input type="text" name="tamano" parsley-trigger="change" required
                                                       placeholder="Tamaño" class="form-control" id="Tamano" value="<?php echo $producto[5] ?>">
                                            </div>
                                            <div class="form-group">
                                                <label for="Precio">Precio<span class="text-danger">*</span></label>
                                                <input type="text" name="precio" parsley-trigger="change" required
                                                       placeholder="Precio" class="form-control" id="Precio" value="<?php echo $producto[6] ?>">
                                            </div>
