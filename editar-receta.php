                                    ...
                                    <div class="p-20 m-b-20">
                                        <form action="#" class="form-validation">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="ingredientes" parsley-trigger="change" required
                                                       placeholder="" class="form-control" id="ingredientes">
                                            </div>

                                            <div class="form-group">
                                                <label for="instrucciones">Instrucciones<span class="text-danger">*</span></label>
                                                <input type="text" name="instrucciones" parsley-trigger="change" required
                                                       placeholder="" class="form-control" id="instrucciones">
                                            </div>
