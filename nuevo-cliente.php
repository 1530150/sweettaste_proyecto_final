            ...
            <div class="page-contentbar">
                ...
                <div id="page-right-content">
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-sm-12">
                                <h4 class="m-t-0 header-title">Agregar Cliente</h4>
                                        ...
                                        <form action="#" class="form-validation">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="apellidoP" parsley-trigger="change" required
                                                       placeholder="Apellido Paterno" class="form-control" id="apellidoP">
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="apellidoM" parsley-trigger="change" required
                                                       placeholder="Apellido Paterno" class="form-control" id="apellidoM">
                                            </div>

                                            <div class="form-group">
                                                <label for="FechaN">Fecha de nacimiento<span class="text-danger">*</span></label>
                                                <input type="text" name="fechan" parsley-trigger="change" required
                                                       placeholder="Fecha de nacimiento" class="form-control" id="FechaN">
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="codigoP" parsley-trigger="change" required
                                                       placeholder="Código Postal" class="form-control" id="codigoP">
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="telefono" parsley-trigger="change" required
                                                       placeholder="Teléfono" class="form-control" id="Telefono">
                                            </div>
