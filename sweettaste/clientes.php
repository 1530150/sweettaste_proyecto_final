            ...
            <div class="page-contentbar">
                ...
                <div id="page-right-content">
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-sm-12">
                                <h4 class="m-t-0 header-title">Tabla de clientes</h4>
                                <a class="btn btn-rounded btn-success" style="margin-bottom: 10px" href="nuevo-cliente.php">Agregar nuevo</a>
                                ...
                                <div class="table-responsive m-b-20">
                                    <table id="datatable" class="table table-striped table-bordered">
                                        ...
                                        <tr>
                                            <td><?php echo $cliente[0]," ",$cliente[1]," ",$cliente[2] ?></td>
                                            <td><?php echo $cliente[3] ?></td>
                                            <td><?php echo $cliente[4],", ",$cliente[5],", ",$cliente[6],", CP ",$cliente[7] ?></td>
                                            <td><?php echo $cliente[8] ?></td>
                                            <td><?php echo $cliente[9] ?></td>
                                            <td>
                                                <a class="btn btn-rounded btn-custom" href="editar-cliente.php?cliente=<?= $cliente[8] ?>">Editar</a>
