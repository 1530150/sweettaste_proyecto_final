...
$distribuidores = getDistribuidores();
            ...
            <div class="page-contentbar">
                ...
                <div id="page-right-content">
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-sm-12">
                                <h4 class="m-t-0 header-title">Distribuidores</h4>
                                <a class="btn btn-rounded btn-success" style="margin-bottom: 10px" href="nuevo-distribuidor.php">Agregar nuevo</a>
                                ...
                                <div class="table-responsive m-b-20">
                                    <table id="datatable" class="table table-striped table-bordered">
                                        ...
                                        <tr>
                                            <td><?php echo $distribuidor[0] ?></td>
                                            <td><?php echo $distribuidor[1]," ",$distribuidor[2]," ",$distribuidor[3]?></td>
                                            <td><?php echo $distribuidor[4] ?></td>
                                            <td><?php echo $distribuidor[5] ?></td>
                                            <td>
                                                <a class="btn btn-rounded btn-custom" href="editar-distribuidor.php?distribuidor=<?= $distribuidor[4] ?>"">Editar</a>
