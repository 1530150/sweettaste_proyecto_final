...
conectar();
$usuario = getUsuario();
$cliente = getCliente($_GET['cliente']);
            ...
            <div class="page-contentbar">
                ...
                <div id="page-right-content">
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-sm-12">
                                <h4 class="m-t-0 header-title">Editar Cliente</h4>
                                <a href="clientes.php" class="btn btn-custom" style="float: right; display: inline;">Atrás</a>

                               <div class="col-lg-6">
                                <div class="p-20 m-b-20">
                                    <div class="p-20 m-b-20">
                                        <form action="modificar/modificar-cliente.php" class="form-validation" method="POST">

                                            <input type="hidden" name="emaili" value="<?php echo $cliente[8] ?>">

                                            <div class="form-group">
                                                <label for="Nombre">Nombre<span class="text-danger">*</span></label>
                                                <input type="text" name="nombre" parsley-trigger="change" required
                                                       placeholder="Nombre" class="form-control" id="Nombre" value="<?php echo $cliente[0] ?>">
                                            </div>

                                            <div class="form-group">
                                                <label for="apellidoP">Apellido Paterno<span class="text-danger">*</span></label>
                                                <input type="text" name="apellidoP" parsley-trigger="change" required
                                                       placeholder="Apellido Paterno" class="form-control" id="apellidoP" value="<?php echo $cliente[1] ?>">
                                            </div>

                                            <div class="form-group">
                                                <label for="apellidoM">Apellido Materno<span class="text-danger">*</span></label>
                                                <input type="text" name="apellidoM" parsley-trigger="change" required
                                                       placeholder="Apellido Paterno" class="form-control" id="apellidoM" value="<?php echo $cliente[2] ?>">
                                            </div>
                                            ...
                                            <div class="form-group m-b-20">
                                                ...
                                                <div>
                                                    <div class="input-group">
                                                        <input type="text" class="form-control" placeholder="mm/dd/yyyy" id="datepicker-autoclose" name="fecha" value="<?php echo $cliente[3] ?>">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="calle" parsley-trigger="change" required
                                                       placeholder="Calle" class="form-control" id="calle" value="<?php echo $cliente[4] ?>">
                                            </div>

                                            <div class="form-group">
                                                <label for="numero">Número<span class="text-danger">*</span></label>
                                                <input type="text" name="numero" parsley-trigger="change" required
                                                       placeholder="Número" class="form-control" id="numero" value="<?php echo $cliente[5] ?>">
                                            </div>

                                            <div class="form-group">
                                                <label for="colonia">Colonia<span class="text-danger">*</span></label>
                                                <input type="text" name="colonia" parsley-trigger="change" required
                                                       placeholder="Colonia" class="form-control" id="colonia" value="<?php echo $cliente[6] ?>">
                                            </div>

                                            <div class="form-group">
                                                <label for="codigoP">Código Postal<span class="text-danger">*</span></label>
                                                <input type="text" name="codigoP" parsley-trigger="change" required
                                                       placeholder="Código Postal" class="form-control" id="codigoP" value="<?php echo $cliente[7] ?>">
                                            </div>

                                            <div class="form-group">
                                                <label for="email">e-mail<span class="text-danger">*</span></label>
                                                <input type="text" name="email" parsley-trigger="change" required
                                                       placeholder="e-mail" class="form-control" id="email" value="<?php echo $cliente[8] ?>" disabled="disabled">
                                            </div>

                                            <div class="form-group">
                                                <label for="telefono">Teléfono<span class="text-danger">*</span></label>
                                                <input type="text" name="telefono" parsley-trigger="change" required
                                                       placeholder="Teléfono" class="form-control" id="Telefono" value="<?php echo $cliente[9] ?>">
                                            </div>
