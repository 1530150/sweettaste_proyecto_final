            ...
            <div class="page-contentbar">
                ...
                <div id="page-right-content">
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-sm-12">
                                <h4 class="m-t-0 header-title">Editar equipo</h4>
                                <a href="equipo.php" class="btn btn-custom" style="float: right; display: inline;">Atrás</a>

                               <div class="col-lg-12">
                                <div class="p-20 m-b-20">
                                    <div class="p-20 m-b-20">
                                        <form action="modificar/modificar-equipo.php" class="form-validation" method="POST">

                                            <input type="hidden" name="id" value="<?php echo $equipo[0] ?>">

                                            <div class="form-group">
                                                <label for="Nombre">Nombre<span class="text-danger">*</span></label>
                                                <input type="text" name="nombre" parsley-trigger="change" required
                                                       placeholder="Nombre" class="form-control" id="Nombre" value="<?php echo $equipo[1] ?>">
                                            </div>

                                            <div class="row">
                                                <div class="col-sm-12">
                                                    <div class="p-20 m-b-20">
                                                        <h4 class="m-b-30 m-t-0 header-title">Descripción</h4>
                                                        <textarea class="summernote" name="descripcion">
                                                            <?php echo $equipo[2] ?>"
                                                        </textarea>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="form-group m-b-20">
                                                ...
                                                <div>
                                                    <div class="input-group">
                                                        <input type="text" class="form-control" placeholder="mm/dd/yyyy" id="datepicker-autoclose" name="fecha" value="<?php echo $equipo[3] ?>">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="costo" parsley-trigger="change" required
                                                       placeholder="Costo" class="form-control" id="costo" value="<?php echo $equipo[4] ?>">
                                            </div>
