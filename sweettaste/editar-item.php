            ...
            <div class="page-contentbar">
                ...
                <div id="page-right-content">
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-sm-12">
                                <h4 class="m-t-0 header-title">Editar item</h4>
                                <a href="inventario.php" class="btn btn-custom" style="float: right; display: inline;">Atrás</a>

                               <div class="col-lg-6">
                                <div class="p-20 m-b-20">
                                    <div class="p-20 m-b-20">
                                        <form action="modificar/modificar-item.php" class="form-validation" method="POST">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="nombre" parsley-trigger="change" required
                                                       placeholder="Nombre" class="form-control" id="Nombre" value="<?php echo $item[1] ?>">
                                            </div>
                                            <div class="form-group">
                                                <label for="marca">Marca<span class="text-danger">*</span></label>
                                                <input type="text" name="marca" parsley-trigger="change" required
                                                       placeholder="Marca" class="form-control" id="marca" value="<?php echo $item[2] ?>">
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="presentacion" parsley-trigger="change" required
                                                       placeholder="Presentación" class="form-control" id="presentacion" value="<?php echo $item[3] ?>">
                                            </div>
                                            <div class="form-group">
                                                <label for="Costo">Costo<span class="text-danger">*</span></label>
                                                <input type="text" name="costo" parsley-trigger="change" required
                                                       placeholder="Costo" class="form-control" id="costo" value="<?php echo $item[4] ?>">
                                            </div>
