            ...
            <div class="page-contentbar">
                ...
                <div id="page-right-content">
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-sm-12">
                                <h4 class="m-t-0 header-title">Editar Receta</h4>
                                <a href="recetas.php" class="btn btn-custom" style="float: right; display: inline;">Atrás</a>

                               <div class="col-lg-12">
                                <div class="p-20 m-b-20">
                                    <div class="p-20 m-b-20">
                                        <form action="modificar/modificar-receta.php" class="form-validation" method="POST">

                                            <input type="hidden" name="id" value="<?php echo $receta[0] ?>">

                                            <div class="form-group">
                                                <?php $productoR =  mysqli_fetch_array(mysqli_query($conexion, "SELECT nombre FROM productos WHERE id='$receta[0]'")) ?>
                                                <label for="producto">Producto<span class="text-danger">*</span></label>
                                                <select name="producto" id="producto" disabled="disabled">
                                                    <option value="<?php echo $receta[0] ?>" selected="selected"><?php echo $productoR[0] ?></option>
                                                <select/>
                                            </div>
                                            ...
                                            <div class="row">
                                                <div class="col-sm-12">
                                                    <div class="p-20 m-b-20">
                                                        <h4 class="m-b-30 m-t-0 header-title">Ingredientes</h4>
                                                        <textarea class="summernote" name="ingredientes">
                                                            <?php echo $receta[1] ?>
                                                        </textarea>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="row">
                                                <div class="col-sm-12">
                                                    <div class="p-20 m-b-20">
                                                        <h4 class="m-b-30 m-t-0 header-title">Instrucciones</h4>
                                                        <textarea class="summernote" name="instrucciones">
                                                            <?php echo $receta[2] ?>
                                                        </textarea>
                                                    </div>
                                                </div>
