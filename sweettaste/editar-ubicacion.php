...
conectar();
$usuario = getUsuario();
$ubicacion = getUbicacion($_GET['ubicacion']);
            ...
            <div class="page-contentbar">
                ...
                <div id="page-right-content">
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-sm-12">
                                <h4 class="m-t-0 header-title">Editar Ubicación</h4>
                                <a href="ubicaciones.php" class="btn btn-custom" style="float: right; display: inline;">Atrás</a>

                               <div class="col-lg-6">
                                <div class="p-20 m-b-20">
                                    <div class="p-20 m-b-20">
                                        <form action="modificar/modificar-ubicacion.php" class="form-validation" method="POST">

                                            <input type="hidden" name="id" value="<?php echo $ubicacion[0] ?>">

                                            <div class="form-group">
                                                <label for="Nombre">Nombre<span class="text-danger">*</span></label>
                                                <input type="text" name="nombre" parsley-trigger="change" required
                                                       placeholder="Nombre" class="form-control" id="Nombre" value="<?php echo $ubicacion[1] ?>">
                                            </div>
                                            <div class="form-group">
                                                <label for="calle">Calle<span class="text-danger">*</span></label>
                                                <input type="text" name="calle" parsley-trigger="change" required
                                                       placeholder="Calle" class="form-control" id="calle" value="<?php echo $ubicacion[2] ?>">
                                            </div>
                                            <div class="form-group">
                                                <label for="numero">Número<span class="text-danger">*</span></label>
                                                <input type="text" name="numero" parsley-trigger="change" required
                                                       placeholder="Número" class="form-control" id="numero" value="<?php echo $ubicacion[3] ?>">
                                            </div>
                                            <div class="form-group">
                                                <label for="colonia">Colonia<span class="text-danger">*</span></label>
                                                <input type="text" name="colonia" parsley-trigger="change" required
                                                       placeholder="Colonia" class="form-control" id="colonia" value="<?php echo $ubicacion[4] ?>">
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="codigop" parsley-trigger="change" required
                                                       placeholder="Código Postal" class="form-control" id="codigop" value="<?php echo $ubicacion[5] ?>">
                                            </div>
