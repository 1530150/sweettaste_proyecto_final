                            ...
                            <div class="col-sm-12">
                               ...
                               <div class="col-lg-6">
                                <div class="p-20 m-b-20">
                                    <div class="p-20 m-b-20">
                                        <form action="agregar/agregar-producto.php" class="form-validation" method="POST">
