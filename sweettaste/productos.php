            ...
            <div class="page-contentbar">
                ...
                <div id="page-right-content">
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-sm-12">
                                <h4 class="m-t-0 header-title">Tabla de productos</h4>
                                <a class="btn btn-rounded btn-success" style="margin-bottom: 10px" href="nuevo-producto.php">Agregar nuevo</a>
                                ...
                                <div class="table-responsive m-b-20">
                                    <table id="datatable" class="table table-striped table-bordered">
                                        ...
                                        <tr>
                                            ...
                                            <td>$<?php echo $producto[6] ?> pesos</td>
                                            <td>
                                                <a class="btn btn-rounded btn-custom" href="editar-producto.php?producto=<?= $producto[0] ?>">Editar</a>
