            ...
            <div class="page-contentbar">
                ...
                <div id="page-right-content">
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-sm-12">
                                <h4 class="m-t-0 header-title">Solicitudes de registro</h4>
                                ...
                                <div class="table-responsive m-b-20">
                                    <table id="datatable" class="table table-striped table-bordered">
                                        ...
                                        <tr>
                                            <td><?php echo $usuario[0]," ",$usuario[1]," ",$usuario[2] ?></td>
                                            <td><?php echo $usuario[3] ?></td>
                                            <td><?php echo $usuario[4],", ",$usuario[5],", ",$usuario[6],", CP ",$usuario[7] ?></td>
                                            <td><?php echo $usuario[8] ?></td>
                                            <td><?php echo $usuario[9] ?></td>
                                            <td>
                                                <a class="btn btn-rounded btn-custom" href="modificar/aceptar-usuario.php?usuario=<?= $usuario[8] ?>">Aceptar</a>
