                            ...
                            <div class="col-sm-12">
                                <div class="timeline">
                                        ...
                                        <div class="timeline-desk">
                                            <div class="panel">
                                                <div class="timeline-box">
                                                    ...
                                                    <h4 class="">Hace 1 hora</h4>
                                                    <p class="timeline-date text-muted"><small>05:25 pm</small></p>
                                                    <p>Un usuario nuevo se registró </p>
                                                </div>
                                            </div>
                                        </div>
                                    </article>
                                        ...
                                        <div class="timeline-desk">
                                            <div class="panel">
                                                <div class="timeline-box">
                                                    ...
                                                    <h4 class="text-success">Hace 2 horas</h4>
                                                    <p class="timeline-date text-muted"><small>04:12 pm</small></p>
                                                    <p>Se agregó un nuevo producto al sistema</p>
                                        ...
                                        <div class="timeline-desk">
                                            <div class="panel">
                                                <div class="timeline-box">
                                                    ...
                                                    <h4 class="text-primary">Hace 5 horas</h4>
                                                    <p class="timeline-date text-muted"><small>01:04 pm</small></p>
                                                    <p>Se registró un nuevo pedido</p>
                                                    <!--<div class="album">-->
                                                        <!--<a href="#">-->
                                        ...
                                        <div class="timeline-desk">
                                            <div class="panel">
                                                <div class="timeline-box">
                                                    ...
                                                    <h4 class="text-danger">Hace 8 horas</h4>
                                                    <p class="timeline-date text-muted"><small>10:12 am</small></p>
                                                    <p>Se modificó una receta</p>
                                                </div>
                                            </div>
                                        </div>
                                    </article>
                                        ...
                                        <div class="timeline-desk">
                                            <div class="panel">
                                                <div class="timeline-box">
                                                    <span class="arrow-alt"></span>
                                                    <span class="timeline-icon"><i class="mdi mdi-checkbox-blank-circle-outline"></i></span>
                                                    <h4 class="text-muted">Hace 19 horas</h4>
                                                    <p class="timeline-date text-muted"><small>11:32 pm</small></p>
                                                    <p>Se agregó un nuevo item al inventario</p>
                                                </div>
                                            </div>
                                        </div>
                                    </article>
                                        ...
                                        <div class="timeline-desk">
                                            <div class="panel">
                                                <div class="timeline-box">
                                                    ...
                                                    <h4 class="text-warning">12 Noviembre 2017</h4>
                                                    <p class="timeline-date text-muted"><small>03:15 pm</small></p>
                                        ...
                                        <div class="timeline-desk">
                                            <div class="panel">
                                                <div class="timeline-box">
                                                    <span class="arrow-alt"></span>
                                                    <span class="timeline-icon bg-primary"><i class="mdi mdi-checkbox-blank-circle-outline"></i></span>
                                                    <h4 class="text-primary">12 Noviembre 2017</h4>
                                                    <p class="timeline-date text-muted"><small>12:31 pm</small></p>
                                                    <p>Se completó un pedido</p>
                                                </div>
                                            </div>
                                        </div>
                                    </article>
                                        ...
                                        <div class="timeline-desk">
                                            <div class="panel">
                                                <div class="timeline-box">
                                                    <span class="arrow"></span>
                                                    <span class="timeline-icon bg-success"><i class="mdi mdi-checkbox-blank-circle-outline"></i></span>
                                                    <h4 class="text-success">12 Noviembre 2017</h4>
                                                    <p class="timeline-date text-muted"><small>11:02 am</small></p>
                                                    <p>Se agregó un nuevo cliente</p>
                                                </div>
                                            </div>
                                        </div>
                                    </article>
                                    <article class="timeline-item alt">
                                        <div class="text-right">
                                            <div class="time-show">
                                                <a href="#" class="btn btn-custom">El mes pasado</a>
                                            </div>
                                        </div>
                                    </article>
                                        ...
                                        <div class="timeline-desk">
                                            <div class="panel">
                                                <div class="timeline-box">
                                                    <span class="arrow-alt"></span>
                                                    <span class="timeline-icon"><i class="mdi mdi-checkbox-blank-circle-outline"></i></span>
                                                    <h4 class="text-muted">28 Octubre 2017</h4>
                                                    <p class="timeline-date text-muted"><small>6:41 pm</small></p>
                                                    <p>Se agregó un nuevo pedido</p>
                                                </div>
                                            </div>
                                        </div>
                                    </article>
                                        ...
                                        <div class="timeline-desk">
                                            <div class="panel">
                                                <div class="timeline-box">
                                                    <span class="arrow"></span>
                                                    <span class="timeline-icon bg-danger"><i class="mdi mdi-checkbox-blank-circle-outline"></i></span>
                                                    <h4 class="text-danger">21 Octubre 2017</h4>
                                                    <p class="timeline-date text-muted"><small>12:24 pm</small></p>
                                                    <p>Se eliminó un cliente</p>
                                                </div>
                                            </div>
                                        </div>
                                    </article>
