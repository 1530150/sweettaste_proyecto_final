...
<html lang="en">
    <head>
        <meta charset="utf-8" />
        <title>Ubicaciones de entrega</title>
            ...
            <div class="page-contentbar">
                ...
                <div id="page-right-content">
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-sm-12">
                                <h4 class="m-t-0 header-title">Tabla de ubicaciones de entrega</h4>
                                <a class="btn btn-rounded btn-success" style="margin-bottom: 10px" href="nueva-ubicacion.php">Agregar nuevo</a>
                                ...
                                <div class="table-responsive m-b-20">
                                    <table id="datatable" class="table table-striped table-bordered">
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo $ubicacion[5] ?></td>
                                            <td>
                                                <a class="btn btn-rounded btn-custom" href="editar-ubicacion.php?ubicacion=<?= $ubicacion[0] ?>">Editar</a>
