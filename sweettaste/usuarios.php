            ...
            <div class="page-contentbar">
                ...
                <div id="page-right-content">
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-sm-12">
                                <h4 class="m-t-0 header-title">Tabla de usuarios</h4>
                                ...
                                <div class="table-responsive m-b-20">
                                    <table id="datatable" class="table table-striped table-bordered">
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo getNivelP($usuario[8]) ?></td>
                                            ...
                                            <td>
                                                <a class="btn btn-rounded btn-custom" href="editar-nivel.php?usuario=<?= $usuario[8] ?>">Editar nivel</a>
